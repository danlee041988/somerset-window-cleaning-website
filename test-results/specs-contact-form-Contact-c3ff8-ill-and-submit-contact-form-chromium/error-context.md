...
- main:
  ...
  - text: Phone number
  - textbox "Phone number": "07123456789"
  - text: Address
  - textbox "Address": 123 Test Street, Test Town
  - text: Postcode
  - textbox "Postcode": BA6 8AB
  - text: Property type
  - combobox "Property type":
    - option "Terraced (2 bed)"
    - option "Terraced (3 bed)"
    - option "Semi-detached (2 bed)"
    - option "Semi-detached (3 bed)" [selected]
